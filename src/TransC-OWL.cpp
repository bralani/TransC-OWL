...
void init() {
	...
	fin = fopen((inPath + "concept2id.txt").c_str(), "r");
    ...
    FILE* instanceOf_file = fopen((inPath + "/instanceOf2id.txt").c_str(), "r");
    FILE* subClassOf_file = fopen((inPath + "/subClassOf2id.txt").c_str(), "r");
    int a = 0, b = 0;
